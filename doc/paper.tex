...
feature, such as whether a player has made a \type{preemptive bid}.   
...
\tblref{opening-11-12-bal-2} shows the results. About 12.5\% (2427)
...
\tblref{preempt} shows the results for the Bermuda Bowl data
...
contested auction (Y-axis). P-value of the linear model: 0.0324}

\figref{contested-auction} shows the results of this second analysis in
